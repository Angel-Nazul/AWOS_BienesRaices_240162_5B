...
<p align="justify">
El proyecto estara basado en una Arquitectura SOA (Service Oriented Architecture), el Patron de Diseño MVC (Model, View, Controler) y servicios API REST, debera gestionarse debidamente en el uso del contro de versiones y ramas progresivas del desarrollo del mismo.</p>
